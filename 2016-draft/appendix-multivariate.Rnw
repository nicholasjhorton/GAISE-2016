...
Similar results are seen for the subjects who are between 45--64 years old as displayed in Table \ref{tab:whick3} and Figure \ref{fig:whick3}.
This is a classic example of Simpson's paradox\cite{simp:1951}.
...
Mortality rates are highest for the oldest subjects (see Figure \ref{fig:whickage1}) but smoking is also associated with age (see Figure \ref{fig:whickage2}).  After controlling for age, smokers have a higher
