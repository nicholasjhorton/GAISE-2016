...
% XX add pointer to Starnes paper?
% XX add pointer to SET?
...
Therefore, \added{key ideas} need to be aligned with learning goals.
\marginnote{\url{CAUSEweb.org} hosts a repository of learning outcomes for introductory statistics courses.}
